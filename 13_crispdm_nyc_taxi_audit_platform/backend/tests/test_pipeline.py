...
from app.monitoring import population_stability_index, _status
...
def test_drift_status_thresholds():
    assert _status(0.01, 0.02) == "green"
    assert _status(0.15, 0.05) == "yellow"
    assert _status(0.30, 0.05) == "red"
