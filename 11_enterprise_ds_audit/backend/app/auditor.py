...
from app.config import ALLOWED_ROOTS, WORKSPACE_ROOT
from app.fsutil import iter_python_files
from app.schemas import AuditResponse, Finding
from app.scoring import build_dimension_scores, letter_grade, overall_from_dimensions
...
def run_audit(project_root: Path) -> AuditResponse:
