"""Fetch Adult Income (OpenML) for AutoGluon Tabular demo."""
...
Label column: class (values '<=50K' / '>50K' normalized to binary strings).
"""
...
def fetch_adult(n: int | None = None, seed: int = 42) -> pd.DataFrame:
    ...
    df = bunch.frame.copy()
    # Normalize label name used throughout the app
